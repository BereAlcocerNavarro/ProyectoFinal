...
namespace ProyectoFinal.Controllers
{
    public class CalificacionesController : Controller
    {
        ...
        public CalificacionesController(ProyectoFinalContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Calificacion != null ? 
                          ...
                          Problem("Entity set 'ProyectoFinalContext.Calificacion'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,IdAlumno,IdMateria,Score")] Calificacion calificacion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,IdAlumno,IdMateria,Score")] Calificacion calificacion)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ProyectoFinalContext.Calificacion'  is null.");
            }
            var calificacion = await _context.Calificacion.FindAsync(id);
            if (calificacion != null)
            {
