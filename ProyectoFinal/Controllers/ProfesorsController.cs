...
namespace ProyectoFinal.Controllers
{
    public class ProfesorsController : Controller
    {
        ...
        public ProfesorsController(ProyectoFinalContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Profesor != null ? 
                          ...
                          Problem("Entity set 'ProyectoFinalContext.Profesor'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Telefono,Turno")] Profesor profesor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Telefono,Turno")] Profesor profesor)
        {
            if (id != profesor.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ProyectoFinalContext.Profesor'  is null.");
            }
            var profesor = await _context.Profesor.FindAsync(id);
            if (profesor != null)
            {
